...
**New here?** Unzip → open **`START-HERE.md`** → then **`ONBOARDING.md`** → [INSTALL.md](docs/INSTALL.md) for steps.
...
## Kit repo (maintainers)

Private kit repo for Operator Intelligence: a Grok plugin plus business-folder template.
